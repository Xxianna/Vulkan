...
# Ensure Emscripten Find modules are available when cross-compiling for Web
if(EMSCRIPTEN)
...
if(RMLUI_BACKEND MATCHES "^SDL" AND NOT TARGET SDL::SDL AND (RMLUI_SDL_VERSION_MAJOR EQUAL "2" OR RMLUI_SDL_VERSION_MAJOR STREQUAL ""))
	...
	if(RMLUI_SDLIMAGE_REQUIRED)
		# For Emscripten, include the Emscripten-specific Find module directly
		if(EMSCRIPTEN AND EXISTS "${CMAKE_CURRENT_SOURCE_DIR}/CMake/Modules/Emscripten/FindSDL2_image.cmake")
			include("${CMAKE_CURRENT_SOURCE_DIR}/CMake/Modules/Emscripten/FindSDL2_image.cmake")
		else()
